...
```{r Fig. 1, warning = FALSE, dev = c("png","tiff"), fig.height = 3, fig.width = 10, fig.cap = "Fig. 1"}
cowplot::plot_grid(
...
```{r, fig.cap = "Fig. Detrended values in (c) are residuals from linear models in Fig. 2 (a) and (b). Each dot is one observation; fitted lines are shown with 95% confidence intervals (shaded areas)."}
