...
ch_biom15$altitude_sc <- ch_biom15$altitude
```
...
```{r Fig. 1, warning = F, dev = c("png","tiff"), fig.height = 5, fig.width = 10, fig.cap = "Fig. 1 SOMETHING"}
grid.arrange(
